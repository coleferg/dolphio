...
extern const BehaviorScript bhvWhitePuffSmoke3[];
...
extern const BehaviorScript bhvToadEvil[];
extern const BehaviorScript bhvToadBasic[];
extern const BehaviorScript bhvToadCultSpawner[];
...
extern const BehaviorScript bhvGoldRingSpawner[];
extern const BehaviorScript bhvJetStreamWaterRing[];
extern const BehaviorScript bhvGoldWaterRing[];
...
extern const BehaviorScript bhvStar[];
extern const BehaviorScript bhvStarNoExit[];
...
extern const BehaviorScript bhvGoldRingStar[];
...
extern const BehaviorScript bhvMonkat[];
extern const BehaviorScript bhvSloth[];
extern const BehaviorScript bhvLizard[];
extern const BehaviorScript bhvFruit[];
extern const BehaviorScript bhvSlidingDoor[];
extern const BehaviorScript bhvJellycube[];
