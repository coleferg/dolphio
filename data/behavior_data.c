...
const BehaviorScript bhvWhitePuffSmoke3[] = {
    BEGIN(OBJ_LIST_UNIMPORTANT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_INT(oAnimState, -1),
    BEGIN_REPEAT(45),
        CALL_NATIVE(bhv_white_puff_3_loop),
        CALL_NATIVE(cur_obj_move_using_fvel_and_gravity),
        ADD_INT(oAnimState, 1),
    END_REPEAT(),
    DEACTIVATE(),
...
const BehaviorScript bhvToadMessage[] = {
    ...
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 100),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 40, /*Gravity*/ -200, /*Bounciness*/ -50, /*Drag*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 205, /*Unused*/ 0, 0),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 8000),
    SET_HOME(),
    CALL_NATIVE(bhv_init_room),
...
const BehaviorScript bhvToadBasic[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, toad_seg6_anims_0600FB58),
    ANIMATE(6),
    ...
    SET_HOME(),
    CALL_NATIVE(bhv_init_room),
    CALL_NATIVE(bhvToadBasic_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhvToadBasic_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvToadEvil[] = {
    ...
    SET_INT(oDamageOrCoinValue, 2),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 100),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 40, /*Gravity*/ -200, /*Bounciness*/ -20, /*Drag*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 205, /*Unused*/ 0, 0),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 8000),
    SET_HOME(),
    CALL_NATIVE(bhv_init_room),
    CALL_NATIVE(bhvToadEvil_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhvToadEvil_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvCelebrationStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_ANIMATIONS(oAnimations, fruit_anims),
    ANIMATE(0),
...
// 3E1C
const BehaviorScript bhvFruit[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    LOAD_ANIMATIONS(oAnimations, fruit_anims),
    ANIMATE(0),
    SET_INT(oInteractionSubtype, INT_SUBTYPE_NO_EXIT),
    CALL_NATIVE(bhv_init_room),
    CALL_NATIVE(bhv_collect_fruit_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_collect_fruit_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvMonkat[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, monkat_anims),
    ANIMATE(1),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 100),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 40, /*Gravity*/ -200, /*Bounciness*/ -50, /*Drag*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 205, /*Unused*/ 0, 0),
    ...
    SET_HOME(),
    CALL_NATIVE(bhv_init_room),
    CALL_NATIVE(bhvMonkatBasic_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhvMonkatBasic_loop),
    END_LOOP(),
};

const BehaviorScript bhvSloth[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, sloth_anims),
    ANIMATE(0),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 100),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 40, /*Gravity*/ -200, /*Bounciness*/ -50, /*Drag*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 205, /*Unused*/ 0, 0),
    ...
    SET_HOME(),
    CALL_NATIVE(bhv_init_room),
    CALL_NATIVE(bhvSlothBasic_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhvSlothBasic_loop),
    END_LOOP(),
};

const BehaviorScript bhvLizard[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, lizard_anims),
    ANIMATE(1),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 50),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 1, /*Gravity*/ -200, /*Bounciness*/ -50, /*Drag*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 1500, /*Unused*/ 0, 0),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 8000),
    SET_HOME(),
    CALL_NATIVE(bhv_init_room),
    CALL_NATIVE(bhvLizardBasic_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhvLizardBasic_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvSlidingDoor[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_MOVE_XZ_USING_FVEL)),
    DROP_TO_FLOOR(),
    ADD_FLOAT(oPosY, 1),
    SET_HOME(),
...
const BehaviorScript bhvJellycube[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_MOVE_XZ_USING_FVEL)),
    LOAD_ANIMATIONS(oAnimations, jellycube_anims),
    SET_HOME(),
    SET_FLOAT(oDrawingDistance, 10000),
    CALL_NATIVE(bhv_init_room),
    CALL_NATIVE(bhvJellycube_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhvJellycube_loop),
    END_LOOP(),
};