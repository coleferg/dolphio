...
void render_hud_coins(void) {
    print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X), HUD_TOP_Y - 16, "+"); // 'Coin' glyph
    // print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X) + 16, HUD_TOP_Y, "*"); // 'X' glyph
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X - 16), HUD_TOP_Y - 16, "%d", gHudDisplay.coins);
}
...
void render_hud_stars(void) {
    ...
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X - 16),
                       HUD_TOP_Y, "%d", gHudDisplay.fruit);
}
...
//     }
// }
void render_extra_jump(void) {
    print_text(10, 10, "-"); // TODO: Change glyph
}
...
void render_hud(void) {
    ...
    if (hudDisplayFlags == HUD_DISPLAY_NONE) {
        ...
        if (hudDisplayFlags & HUD_DISPLAY_FLAG_EXTRA_JUMP) {
            render_extra_jump();
        }
