...
struct MovtexObject gMovtexNonColored[] = {
    ...
    { MOVTEX_BITFS_LAVA_FIRST, TEXTURE_LAVA, 4, NULL,
      dl_waterbox_rgba16_begin, dl_waterbox_end, NULL, 0xff, 0xff, 0xff, 0xff,
      LAYER_OPAQUE },
    { MOVTEX_BITFS_LAVA_SECOND, TEXTURE_LAVA, 4, NULL,
      dl_waterbox_rgba16_begin, dl_waterbox_end, NULL, 0xff, 0xff, 0xff, 0xb4,
      LAYER_TRANSPARENT },
    { MOVTEX_BITFS_LAVA_FLOOR, TEXTURE_LAVA, 9, NULL, dl_waterbox_rgba16_begin,
      dl_waterbox_end, NULL, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT },
