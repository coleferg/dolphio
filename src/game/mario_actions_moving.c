...
// #define WALKING_SPEED_LIMIT 48.0f
#define WALKING_SPEED_LIMIT 58.0f
...
void update_walking_speed(struct MarioState *m) {
    ...
    if (m->forwardVel > WALKING_SPEED_LIMIT) {
        m->forwardVel = WALKING_SPEED_LIMIT;
    }
