...
void cur_obj_set_animation_accel(f32 accel) {
    struct Animation *anim = o->header.gfx.animInfo.curAnim;
    s32 animAccel = (s32)(accel * 65536.0f);

    o->header.gfx.animInfo.animYTrans = 0;
    o->header.gfx.animInfo.animFrameAccelAssist =
    ...
    o->header.gfx.animInfo.animAccel = animAccel;
}
...
void cur_obj_force_mario_interaction(void) {
    gMarioState->marioObj->collidedObjs[gMarioState->marioObj->numCollidedObjs] = o;
    o->collidedObjs[o->numCollidedObjs] = gMarioState->marioObj;

    gMarioState->marioObj->collidedObjInteractTypes |= o->oInteractType;
    o->collidedObjInteractTypes |= gMarioState->marioObj->oInteractType;

    gMarioState->marioObj->numCollidedObjs++;
    o->numCollidedObjs++;
}

s32 is_button_down(s32 button) {
    return gMarioState->controller->buttonDown & button;
}
