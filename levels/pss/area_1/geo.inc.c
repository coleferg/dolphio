...
const GeoLayout pss_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 7668, 2012, 0, pss_dl_rocktubin_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 7668, 2012, 0, pss_dl_rocktubin_001_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
