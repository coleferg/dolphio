...
DEFINE_LEVEL("EXT1 YOKO SCRL", LEVEL_BITDW, COURSE_NONE, bitdw, sky, 20000, 0x00, 0x00, 0x00, _, sCamBitDW) 
DEFINE_LEVEL("EXT7 HORI MINI", LEVEL_VCUTM, COURSE_VCUTM, vcutm, outside, 30000, 0x28, 0x28, 0x28, _, _) 
DEFINE_LEVEL("EXT2 TIKA LAVA", LEVEL_BITFS, COURSE_BITFS, bitfs, sky, 20000, 0x00, 0x00, 0x00, _, sCamBitFS) 
DEFINE_LEVEL("EXT9 SUISOU", LEVEL_SA, COURSE_SA, sa, inside, 20000, 0x10, 0x10, 0x10, _, _) 
DEFINE_LEVEL("EXT3 HEAVEN", LEVEL_BITS, COURSE_BITS, bits, sky, 20000, 0x50, 0x00, 0x00, _, sCamBitS) 
...
DEFINE_LEVEL("EXT4 MINI SLID", LEVEL_PSS, COURSE_PSS, pss, mountain, 20000, 0x00, 0x00, 0x00, _, sCamPSS) 
...
DEFINE_LEVEL("KUPPA1", LEVEL_BOWSER_1, COURSE_BITDW, bowser_1, generic, 20000, 0x00, 0x00, 0x00, _, sCamBowser_1) 
