...
const LevelScript level_bitdw_entry[] = {
    ...
    AREA(/*index*/ 1, world_geo),
        ...
        OBJECT(/*model*/ MODEL_TOAD,                       /*pos*/ -1006, 5536,     321,  /*angle*/ 0, 300, 0,    /*behParam*/ DIALOG_082 << 24, /*beh*/ bhvToadMessage),
        OBJECT(/*model*/ MODEL_TOAD,                       /*pos*/  -346, 1150,   -6411,  /*angle*/ 0, 11, 0,    /*behParam*/ DIALOG_133 << 24, /*beh*/ bhvToadMessage),
        OBJECT(/*model*/ MODEL_TOAD,                       /*pos*/ -2727, 1464,     286,  /*angle*/ 0, 77, 0,   /*behParam*/ DIALOG_134 << 24, /*beh*/ bhvToadMessage),
    ...
    FREE_LEVEL_POOL(),
    MARIO_POS(/*area*/ 1, /*yaw*/ 180, /*pos*/ 294, 1305, 882),
