...
static const LevelScript script_func_local_3[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1135, 1079, -5824,  /*angle*/ 0, 0, 0, /*behParam*/ 0x0, /*beh*/ bhvJetStreamRingSpawner),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1954, 4553, -3963,  /*angle*/ 0, 0, 0, /*behParam*/ 0x0, /*beh*/ bhvJetStreamRingSpawner),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1954, 4553, -2779,  /*angle*/ 0, 0, 0, /*behParam*/ 0x0, /*beh*/ bhvJetStreamRingSpawner),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ 496,  4750, -1643,  /*angle*/ 0, 0, 0, /*behParam*/ 0x0, /*beh*/ bhvJetStreamRingSpawner),
    // OBJECT(/*model*/ MODEL_NONE, /*pos*/-3266, 5346, -2007,  /*angle*/ 0, 0, 0, /*behParam*/ 0x0, /*beh*/ bhvJetStreamRingSpawner),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/-3266, 5182, -2943,  /*angle*/ 0, 0, 0, /*behParam*/ 0x0, /*beh*/ bhvJetStreamRingSpawner),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/-3266, 6150, -3165,  /*angle*/ 0, 0, 0, /*behParam*/ 0x0, /*beh*/ bhvJetStreamRingSpawner),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/-2289, 6231, -3807,  /*angle*/ 0, 0, 0, /*behParam*/ 0x0, /*beh*/ bhvJetStreamRingSpawner),
    // OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1135, 1579, -5024,  /*angle*/ 0, 0, 0, /*behParam*/ 0x1, /*beh*/ bhvGoldRingSpawner),
    // OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1135, 1579, -4024,  /*angle*/ 0, 0, 0, /*behParam*/ 0x2, /*beh*/ bhvGoldRingSpawner),
    // OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1135, 1579, -3024,  /*angle*/ 0, 0, 0, /*behParam*/ 0x4, /*beh*/ bhvGoldRingSpawner),
    // OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1135, 1579, -2024,  /*angle*/ 0, 0, 0, /*behParam*/ 0x8, /*beh*/ bhvGoldRingSpawner),
    // OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1135, 1579, -1024,  /*angle*/ 0, 0, 0, /*behParam*/ 0x10, /*beh*/ bhvGoldRingSpawner),
    // OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, 1579, -500,  /*angle*/ 0, 0, 0, /*behParam*/ 0x1 << 5, /*beh*/ bhvGoldRingStar),
    RETURN(),
};
...
const LevelScript level_bitdw_entry[] = {
    ...
    AREA(/*index*/ 1, world_geo),
        ...
        OBJECT(/*model*/ MODEL_NONE,            /*pos*/  294,   1505,  882,  /*angle*/ 0, 180, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvDeathWarp),
        OBJECT(/*model*/ MODEL_NONE,            /*pos*/  0,  1240,   -7687,  /*angle*/ 0, 0, 0, /*behParam*/ 0x000C0000, /*beh*/ bhvDeathWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1625,  4796, -8174, /*angle*/ 0, 0, 0,  /*behParam*/ 0x140D6000, /*beh*/ bhvWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1625,  4796, -7500, /*angle*/ 0, 0, 0,  /*behParam*/ 0x000E0000, /*beh*/ bhvInstantActiveWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0,  1240,   -7687, /*angle*/ 0, 180, 0, /*behParam*/ 0x00240000, /*beh*/ bhvLaunchStarCollectWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0,  1240,   -7687, /*angle*/ 0, 180, 0, /*behParam*/ 0x00250000, /*beh*/ bhvLaunchDeathWarp),
        ...
        WARP_NODE(/*id*/ 0xF0, /*destLevel*/ LEVEL_BITDW, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF1, /*destLevel*/ LEVEL_BITDW, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0x0D, /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0x0E, /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0x24, /*destLevel*/ LEVEL_BOWSER_1, /*destArea*/ 0x01, /*destNode*/ 0x24, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0x25, /*destLevel*/ LEVEL_BOWSER_1, /*destArea*/ 0x01, /*destNode*/ 0x25, /*flags*/ WARP_NO_CHECKPOINT),
        JUMP_LINK(script_func_local_3),
        // JUMP_LINK(script_func_global_16),
        MACRO_OBJECTS(/*objList*/ bitdw_seg7_macro_objs),
        TERRAIN(/*terrainData*/ world_collision),
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0000, /*seq*/ SEQ_LEVEL_CUSTOM),
        TERRAIN_TYPE(/*terrainType*/ TERRAIN_WATER),
    END_AREA(),

    FREE_LEVEL_POOL(),
    MARIO_POS(/*area*/ 1, /*yaw*/ 180, /*pos*/ 294, 1505, 882),
