	AREA(1, bitfs_area_1_level),
		...
		OBJECT(MODEL_NONE, 6446, 4690, 13338, 0, -118, 0, 0x000A0000, bhvInstantActiveWarp),
		MARIO_POS(0x01, -118, 6446, 4678, 13337),
		OBJECT(MODEL_NONE, 70, 6491, 8177, 0, -180, 0, 0x000B0000, bhvInstantActiveWarp),
